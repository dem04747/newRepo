...
\#title: “This is my second attemot to RMARKDOWN” Here’s some prose in a
very special comment. Let’s summarize the built-in dataset `VADeaths`.
...
![](newRepod_files/figure-gfm/dotchart-1.png)<!-- -->
